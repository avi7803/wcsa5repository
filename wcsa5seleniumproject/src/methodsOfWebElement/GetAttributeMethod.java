...
public class GetAttributeMethod {
	...
	public static void main(String[] args) {
     ...
     WebElement classAttribute = driver.findElement(By.xpath("//p[contains(@class,'oxd-text oxd-text--p orangehrm-login-forgot-header')]"));
	  String classValue = classAttribute.getAttribute("class");
