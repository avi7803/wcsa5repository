...
public class UserPage {
	...
	public void createManager(String username,String password,String firstname,String lastname) throws InterruptedException
	{
		CreateNewUser.click();
		Thread.sleep(1000);
	...
	public void createTestEngineer(String username,String password,String firstname,String lastname) throws InterruptedException
	{
		CreateNewUser.click();
		Thread.sleep(1000);
		Username.sendKeys(username);
